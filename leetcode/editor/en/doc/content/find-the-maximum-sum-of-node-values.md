...
<ul> 
 <li>Choose any edge <code>[u, v]</code> connecting the nodes <code>u</code> and <code>v</code>, and update their values as follows: </li>
</ul>
    <ul>
...
<div><div>Related Topics</div><div><li>Array</li><li>Dynamic Programming</li><li>Greedy</li><li>Bit Manipulation</li><li>Tree</li><li>Sorting</li></div></div><br><div><li>👍 313</li><li>👎 47</li></div>